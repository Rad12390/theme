...
*/
			...
			'privacy_text' => array(
				"title" => esc_html__("Text with Privacy Policy link", 'frank-jewelry-store'),
				"desc"  => wp_kses_data( __("Specify text with Privacy Policy link for the checkbox 'I agree ...'", 'frank-jewelry-store') ),
				"std"   => wp_kses_post( __( 'I agree that my submitted data is being collected and stored.', 'frank-jewelry-store') ),
				"type"  => "text"
			),
			'no_image' => array(
