 ...
 */
			...
			<footer class="site_footer_wrap scheme_<?php echo esc_attr($frank_jewelry_store_footer_scheme); ?>">
				...
				if (!empty($footer_image)) {?>
					...
					<?php
						echo '<img src="'.esc_url($footer_image).'" class="footer_image" alt="'.esc_attr__('footer image', 'frank-jewelry-store').'">';
					?>
					</div>
					<?php
				}
						...
						<div class="logo_footer_wrap">
							<div class="logo_footer_wrap_inner">
								...
								if (!empty($frank_jewelry_store_logo_image)) {
									...
									echo '<a href="'.esc_url(home_url('/')).'"><img src="'.esc_url($frank_jewelry_store_logo_image).'" class="logo_footer_image" alt="'.esc_attr__('footer image', 'frank-jewelry-store').'"'.(!empty($frank_jewelry_store_attr[3]) ? sprintf(' %s', $frank_jewelry_store_attr[3]) : '').'></a>' ;
						...
						<div class="content_wrap">
							<div class="copyright_text"><?php
								...
								if (!empty($frank_jewelry_store_copyright)) {
									frank_jewelry_store_show_layout(do_shortcode(str_replace(array('{{Y}}', '{Y}'), date('Y'), frank_jewelry_store_get_theme_option('copyright'))));
								}
							?></div>
						</div>
					</div>
