...
if (!function_exists('frank_jewelry_store_trx_addons_theme_setup9')) {
	...
	function frank_jewelry_store_trx_addons_theme_setup9() {
		if (frank_jewelry_store_exists_trx_addons()) {
			...
			add_filter( 'trx_addons_filter_override_options_fields',			'frank_jewelry_store_trx_addons_override_options_fields', 10, 2);
			...
			if (is_admin()) {
				add_filter( 'frank_jewelry_store_filter_allow_override_options', 			'frank_jewelry_store_trx_addons_allow_override_options', 10, 2);
...
if (!function_exists('frank_jewelry_store_trx_addons_allow_override_options')) {
	//Handler of the add_filter( 'frank_jewelry_store_filter_allow_override_options', 'frank_jewelry_store_trx_addons_allow_override_options', 10, 2);
	function frank_jewelry_store_trx_addons_allow_override_options($allow, $post_type) {
		return $allow
...
if (!function_exists('frank_jewelry_store_trx_addons_override_options_fields')) {
	//Handler of the add_filter( 'trx_addons_filter_override_options_fields', 'frank_jewelry_store_trx_addons_override_options_fields', 10, 2);
	function frank_jewelry_store_trx_addons_override_options_fields($mb, $post_type) {
		if (defined('TRX_ADDONS_CPT_TEAM_PT') && $post_type==TRX_ADDONS_CPT_TEAM_PT) {
			$mb['email'] = array(
