		...
		<div class="content_wrap">
			<div class="top_panel_title_2">
				...
				if (!empty($frank_jewelry_store_image)) {
					...
					echo '<div class="top_panel_title_2_image"><img src="'.esc_url($frank_jewelry_store_image).'" alt="'.esc_attr__('header title image', 'frank-jewelry-store').'"'.(!empty($frank_jewelry_store_attr[3]) ? sprintf(' %s', $frank_jewelry_store_attr[3]) : '').'></div>';
				}
